...
export interface RoundedSimpleSelectOption {
  value: string
  label: string
}

interface RoundedSimpleSelectProps {
  options: RoundedSimpleSelectOption[]
  value: string
...
export default function RoundedSimpleSelect({
  options,
  value,
  onChange,
  placeholder = "선택하세요",
  ...
  // 옵션 선택
  const handleOptionSelect = (option: RoundedSimpleSelectOption) => {
    ...
    <div className={`relative ${className}`} ref={dropdownRef}>
      ...
      <button
        ...
        className={`
          ...
          text-sm text-left bg-white flex items-center justify-between rounded-lg shadow-sm
